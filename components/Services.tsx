  ...
  const serviceList: ServiceItem[] = [
    {
      ...
      description: "Transforming initial ideas into viable architectural concepts with a focus on spatial efficiency.",
      icon: (
    ...
    },
    {
      ...
      description: "Detailed technical drawings and blueprints ensuring structural integrity and regulatory compliance.",
      icon: (
    ...
    },
    {
      ...
      description: "High-quality visualizations to bring your project to life before construction begins.",
      icon: (
    ...
    },
    {
      ...
      description: "Crafting cohesive interior spaces that harmonize with the architectural shell.",
      icon: (
    ...
    },
    {
      ...
      description: "End-to-end oversight ensuring projects stay on time, within budget, and up to quality standards.",
      icon: (
    ...
    },
    {
      ...
      description: "Ensuring the safety, stability, and durability of every architectural design.",
      icon: (
    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-4xl font-serif font-bold text-gray-900 mb-6">{SITE_CONTENT.services.title}</h2>
          <div className="w-16 h-1 bg-arch-accent mx-auto mb-6"></div>
          <p className="text-gray-600 leading-relaxed">
            {SITE_CONTENT.services.paragraph}
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {serviceList.map((service) => (
            <div key={service.id} className="bg-white p-8 rounded-sm shadow-md hover:shadow-xl transition-shadow duration-300 group">
              <div className="w-14 h-14 bg-gray-100 rounded-full flex items-center justify-center text-arch-accent mb-6 group-hover:bg-arch-accent group-hover:text-white transition-colors duration-300">
                {service.icon}
              </div>
